...
*/
public class Agent extends Person implements PropertyOrganizer{
    ...
    */
    public Agent(String username, String name, String pwd, String email, String phoneNumber, String accType, String owner){
    ...
    */
    public ArrayList<Property> retrieveRentals(String agent){
        for(Property p: Database.allProperties){
            if(p.getOwnedBy().equals(agent) && p.getStatus().equals("Inactive")){
    ...
    */
    ...
    public String toString() {
        return getUsername() + "," + getName() + "," + getPwd() + "," + getEmail() + "," + getPhoneNumber() + "," + getAccType() + "," + getOwner();
    }
